...
/**
 * Start Activity with user input name and
 */
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Disables Confirm button until both fields are filled with something
     */
    ...
    private TextWatcher loginTextWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            /**
             * Saving user input to SQLite when confirm button is pressed
             */
        ...
        public void AddData(String value, String value1) {
            ...
            if (insertData == true) {
                ...
                Toast.makeText(MainActivity.this, "Something when wrong.", Toast.LENGTH_LONG).show();
